    ...
    public class Jeweler : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCRebornAgain.Bestiary.Jeweler")
            });
        }
        ...
        {                                       //NPC names
            string Carl = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Carl");
            string John = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.John");
            string JanMare = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.JanMare");
            string LuiFransua = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.LuiFransua");
            string Daniel = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Daniel");
            string Charley = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Charley");
        ...
        {                                           //npc chat
            string EntryJ1 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ1");
            string EntryJ2 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ2");
            string EntryJ3 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ3");
            string EntryJ4 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ4");
            string EntryJ5 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ5");
            string EntryJ6 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ6");
            string EntryJ7 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ7");
            string EntryJ8 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ8");
            string EntryJ9 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ9");
            string EntryJ10 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryJ10");
        ...
        {
            string ArenaShop = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.ArenaShop");
