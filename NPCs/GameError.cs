...
namespace AlchemistNPCRebornAgain.NPCs
{
    ...
    class GameError : ModNPC
    {
        ...
        public override void BossLoot(ref string name, ref int potionType)
        {
            ...
            Item.NewItem(source, (int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ItemID.OldShoe, 20);
            Item.NewItem(source, (int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ItemID.FishingSeaweed, 20);
            Item.NewItem(source, (int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ItemID.TinCan, 20);
