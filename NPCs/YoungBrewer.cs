...
namespace AlchemistNPCRebornAgain.NPCs
{
    ...
    public class YoungBrewer : ModNPC
    {
        ...
        public override string Texture
        {
            get
            {
                return "AlchemistNPCRebornAgain/NPCs/YoungBrewer";
            }
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCRebornAgain.Bestiary.YoungBrewer")
            });
        }
        ...
        {                                       //NPC names
            string Harold = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Harold");
            string Charles = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Charles");
            string Monty = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Monty");
            string Lucas = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Lucas");
            string Porky = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Porky");
            string Leeland = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Leeland");
            string Atreus = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Atreus");
        ...
        {                                           //npc chat
            string Entry1 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry1");
            string Entry2 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry2");
            string Entry3 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry3");
            string Entry4 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry4");
            string Entry5 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry5");
            string Entry6 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry6");
            string Entry7 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry7");
            string Entry8 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry8");
            string Entry9 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry9");
            string Entry10 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Entry10");
