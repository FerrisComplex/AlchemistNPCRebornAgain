...
namespace AlchemistNPCRebornAgain.NPCs
{
    ...
    public class Tinkerer : ModNPC
    {
        ...
        public override string Texture
        {
            get
            {
                return "AlchemistNPCRebornAgain/NPCs/Tinkerer";
            }
        }
        //Possibly Removed
        ...
        // {
        // 	name = "Tinkerer";
        // 	return AlchemistNPCRebornAgain.modConfiguration.TinkererSpawn;
        // }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCRebornAgain.Bestiary.Tinkerer")
            });
        }
        ...
        {
            string Alexander = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Alexander");
            string Peter = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Peter");
        ...
        {                                           //npc chat
            string EntryT1 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryT1");
            string EntryT2 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryT2");
            string EntryT3 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryT3");
            string EntryT4 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryT4");
            string EntryT5 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryT5");
        ...
        {
            button = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.TinkererButton1");
            button2 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.TinkererButton2");
        }
