    ...
    public class Alchemist : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCRebornAgain.Bestiary.Alchemist")
            });
        }
        ...
        {
            //NPC names
            string Edward = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Edward");
            string Severus = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Severus");
            string Horace = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Horace");
            string Tilyorn = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Tilyorn");
            string Nicolas = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Nicolas");
            string Gregg = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.Gregg");
        ...
        {
            //npc chat
            string EntryA1 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA1");
            string EntryA2 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA2");
            string EntryA3 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA3");
            string EntryA4 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA4");
            string EntryA5 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA5");
            string EntryA6 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA6");
            string EntryA7 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA7");
            string EntryA8 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA8");
            string EntryA9 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA9");
            string EntryA10 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA10");
            string EntryA11 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA11");
            string EntryA12 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA12");
            string EntryA13 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA13");
            string EntryA14 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA14");
            string EntryA15 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA15");
            string EntryA16 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA16");
            string EntryA17 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA17");
            string EntryA18 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA18");
            string EntryA19 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA19");
            string EntryA20 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA20");
            string EntryA21 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA21");
            string EntryA22 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA22");
            string EntryA23 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA23");
            string EntryA24 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA24");
            string EntryA25 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA25");
            string EntryA26 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA26");
            string EntryA27 = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.EntryA27");
        ...
        {
            string PlantsShop = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.PlantsShop");
            string GetCharm = Language.GetTextValue("Mods.AlchemistNPCRebornAgain.GetCharm");
        ...
        public override void AddShops()
        {
            ...
            shop = new NPCShop(Type, PlantShop)
                ...
                .Add(new Item(ItemID.VileMushroom) { shopCustomPrice = 1000 },
                    Condition.DownedEowOrBoc)
                .Add(new Item(ItemID.ViciousMushroom) { shopCustomPrice = 1000 }, Condition.DownedEowOrBoc)
